...
"内蒙古省","辽宁省","吉林省","黑龙江省","江苏省","浙江省",
"安徽省","福建省","江西省","山东省","河南省","湖北省","湖南省",
"广东省","广西省","海南省","四川省","贵州省","云南省","西藏省",
"陕西省","甘肃省","宁夏省","青海省","新疆省","香港","澳门","台湾"
];
...
function init()
{
	...
	province.length=provinceData.length;
	for(var i=0;i<provinceData.length;i++)
	{
		province.options[i].text=provinceData[i];
		province.options[i].value=provinceData[i];
	}
}
